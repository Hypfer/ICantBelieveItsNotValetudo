...
class MapDrawer {
    ...
    draw(skipLayers) {
        ...
        this.mapData.entities.filter(e => e.type === "virtual_wall").forEach(
            virtualWall => {
        ...
        this.mapData.entities.filter(e => e.type === "no_go_area").forEach(
            noGoZone => {
        ...
        const img = croppedMapCanvas.toBuffer();
        const base64 = croppedMapCanvas.toDataURL();
