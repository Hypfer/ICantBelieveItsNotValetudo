...
class MqttClient {
    ...
    constructor(options) {
        ...
        setInterval(() => {
            ...
            if (
                this.mapData.raw.layers && this.mapData.raw.layers.length &&
                this.lastMapData.layers && this.lastMapData.layers.length &&
                JSON.stringify(this.mapData.raw.layers) === JSON.stringify(this.lastMapData.layers) //TODO: deepCompare
            ) {
        ...
        if (!this.client || (this.client && !this.client.connected && !this.client.reconnecting)) {
            ...
            this.client.on("message", (topic, message) => {
                try {
                    ...
                    if (this.mapData.raw.metaData?.version === 2 && Array.isArray(this.mapData.raw.layers)) {
                        this.mapData.raw.layers.forEach(layer => {
