    ...
    DRAW_MAP_PNG: function (options, callback) {
        ...
        new Jimp(BOUNDS.x2-BOUNDS.x1, BOUNDS.y2-BOUNDS.y1, COLORS['background'], function (err, image) {
            if (!err) {
                ...
                if (settings.drawForbiddenZones === true && options.parsedMapData.forbidden_zones.length) {
                ...
                if (settings.drawVirtualWalls === true && options.parsedMapData.virtual_walls.length) {
